<template>
  <div class="splide">
    ...
    <div class="flex ml-1">
      <div><h4 class="flash">Flash Sales</h4></div>
          ...
          <div class="splide_pic">
            <div class="innersplide_pic">
              ...
              <span v-if="item.isNew" class="absolute top-2 right-2  text-black text-xs px-2 py-1" 
                ...
                <span class="mt-1 absolute top-2 left-2  text-white text-xs px-2 py-1 rounded">-
                  {{ item.discount }}%</span>
                  <!--  
    ...
    <div class="text-white btn1"><button class="btn2">View All Products</button></div>
      <div class="mt-20 not-first:border-t-2 border-gray-300">dd</div>
  </div>
</template>
...
export default {
  ...
  setup() {
    ...
    const sliderItems = ref([
      { image: 'gaming-controller.png', name: 'HAVIT dHV-G92 Gamepad', price: '$120', mainPrice: '$160', discount: 40, rating: 5, isNew: true, rateMe:'(88)' },
